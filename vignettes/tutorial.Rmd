...
To run all functionalities in this tutorial, one needs to first install the package optmatch and agree to its
terms of use. Package optmatch may be downloaded from <https://github.com/markmfredrickson/optmatch> if not available on CRAN.
...
for close pairing and the right network is responsible for balancing; See Zhang et al., 2021 for details.
